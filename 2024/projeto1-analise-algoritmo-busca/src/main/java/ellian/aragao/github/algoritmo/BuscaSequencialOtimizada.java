...
public class BuscaSequencialOtimizada extends BaseValidation {
    public <E extends Comparable<E>> Optional<ResultadoBusca<Long, E>> buscaSequencialOtimizadaComSort(List<E> collection,
                                                                                                       E itemDeBusca) {
    ...
    public <E extends Comparable<E>> Optional<ResultadoBusca<Long, E>> buscaSequencialOtimizadaSemSort(List<E> collection,
                                                                                                       E itemDeBusca) {
        if (validation(collection, itemDeBusca)) return Optional.empty();
        return buscaSequencialOtimizada(collection, itemDeBusca);
    }

    private static <E extends Comparable<E>> Optional<ResultadoBusca<Long, E>> buscaSequencialOtimizada(List<E> collection,
                                                                                                        E itemDeBusca) {
